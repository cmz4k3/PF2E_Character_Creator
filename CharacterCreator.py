...
def FinalDisplay(Race, Class, Background, Level, Weapon, RaceFeatChoices, ClassFeatChoices, GeneralFeatChoices, SkillFeatChoices, Focus, RaceInfo, ClassInfo, StatBonuses):
	...
	add1 = Button(Final, text="Add", command= lambda: AddListElement(ClassList, TotalClassFeats, ClassFeatChoices, LastFeatIndex))
	...
	add2 = Button(Final, text="Add", command= lambda: AddListElement(RaceList, TotalRaceFeats, RaceFeatChoices, LastFeatIndex))
	...
	add3 = Button(Final, text="Add", command= lambda: AddListElement(GeneralList, TotalGeneralFeats, GeneralFeatChoices, LastFeatIndex))
	...
	add4 = Button(Final, text="Add", command= lambda: AddListElement(SkillList, TotalSkillFeats, SkillFeatChoices, LastFeatIndex))
...
def Submit(race, background, Class, level, weapon, Attack, Defense, Utility, toggle):
	...
	if(Class.get() == "Select Class" and weapon.get() == "Select Weapon"):
		...
		StatBonuses = GetStatBonus(Focus, Race, RaceDataSheet, Background, BackgroundDataSheet, Class, ClassDataSheet)
...
def GetStatBonus(Focus, Race, RaceDataSheet, Background, BackgroundDataSheet, Class, ClassDataSheet):
